...
export function Rotate3D() {
  return (
    <svg
      ...
      className="icon icon-tabler icons-tabler-outline icon-tabler-rotate-3d"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function VisibleActive3D() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function VisibleInactive3D() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
    ...
    >
      ...
      <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
      <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" />
      <path d="M3.42 3l17.58 18" />
    </svg>
  );
}

export function TrashColor3D() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
